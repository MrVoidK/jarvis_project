...
with status_spinner("[BRAIN] Ollama bağlantısı kontrol ediliyor..."):
    ...
    # sohbet/orkestrator (hermes3:8b) + mini router (qwen2.5:3b) ayri modeller -
    # ikisi de boot'ta dogrulaniyor, ikisi de fatal degil (router eksikse
    # classify() 404'te chat'e duser).
